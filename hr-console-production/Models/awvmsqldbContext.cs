...
namespace hr_console_production.Models
{
    public partial class awvmsqldbContext : DbContext
    {
        public awvmsqldbContext()
        {
        }

        public awvmsqldbContext(DbContextOptions<awvmsqldbContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=tcp:aw-vm-sql-server.database.windows.net,1433;Initial Catalog=aw-vm-sql-db;Persist Security Info=False;User ID=hradmin;Password=@!FA0mega;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
            }
        }
